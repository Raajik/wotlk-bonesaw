...
public:
    ...
    bool matchRealPlayerFollowSpeed;
    float realPlayerFollowSpeedMult;
    float realPlayerFollowSpeedBonus;
    uint32 realPlayerFollowSpeedSyncMs;
