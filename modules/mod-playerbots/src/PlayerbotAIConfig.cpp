...
bool PlayerbotAIConfig::Initialize()
{
    ...
    matchRealPlayerFollowSpeed = sConfigMgr->GetOption<bool>("AiPlayerbot.MatchRealPlayerFollowSpeed", true);
    realPlayerFollowSpeedMult = sConfigMgr->GetOption<float>("AiPlayerbot.RealPlayerFollowSpeedMult", 1.40f);
    realPlayerFollowSpeedBonus = sConfigMgr->GetOption<float>("AiPlayerbot.RealPlayerFollowSpeedBonus", 1.40f);
    realPlayerFollowSpeedSyncMs = sConfigMgr->GetOption<uint32>("AiPlayerbot.RealPlayerFollowSpeedSyncMs", 500);
    ...
    lfgDungeonBotFillSec = sConfigMgr->GetOption<uint32>("AiPlayerbot.LfgDungeonBotFillSec", 15);
