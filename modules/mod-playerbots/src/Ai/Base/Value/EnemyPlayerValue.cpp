...
bool NearestEnemyPlayersValue::AcceptUnit(Unit* unit)
{
    ...
    bool const ffaFight = bot->IsFFAPvP() && enemy && enemy->IsFFAPvP();
    if (enemy && (botAI->IsOpposing(enemy) || ffaFight) && (enemy->IsPvP() || ffaFight) &&
        !bot->IsInSameGroupWith(enemy) && !bot->IsInSameRaidWith(enemy) &&
